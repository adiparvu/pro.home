...
struct PropertyReportView: View {
    ...
    private func generatePDF() -> URL {
        ...
        let url = FileManager.default.temporaryDirectory.appendingPathComponent("PRVHouse_Report_\(Date().timeIntervalSince1970).pdf")
        ...
        try? renderer.writePDF(to: url) { ctx in
            ...
            "Generated by PRVHouse · \(now.string(from: Date()))".draw(at: CGPoint(x: 40, y: 800), withAttributes: footerAttr)
        }
