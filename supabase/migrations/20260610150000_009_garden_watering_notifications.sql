-- ═══════════════════════════════════════════════════════════════════════════
-- PRV HOUSE — Migration 009: Garden watering notification function
-- ═══════════════════════════════════════════════════════════════════════════
-- Called on-demand to surface notifications for plants whose next_watering
-- date has arrived or passed. Deduplicates within a 24-hour window.
